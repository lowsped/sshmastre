...
public class bug_chek extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("http://atsameip.intercode.ca/");
        } else {
